...
public:
  ...
  inline MatrixX3fR getPositionVectors() {
    Eigen::Map<Eigen::Matrix<double_t, Eigen::Dynamic, 3, Eigen::RowMajor>> pos(
        _x.data(), _N, 3);
...
protected:
  ...
  double_t _constrainedValue = 0.0, _K_i = 1000.0, _Lambda_i = 1.0,
           _value = 0.0;
  double_t _f;
  ...
  Surface_mesh::Property_map<Surface_mesh::Vertex_index, Point_with_info>
      _origids;
